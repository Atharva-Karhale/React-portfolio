...
import unspotify from "../Assets/1x/SVG/1x/unspotify.png"
        ...
        onMouseLeave={mouseLeft}>
            ...
            <>
              <div className='relative row-span-1 overflow-hidden lg:absolute lg:col-start-1 lg:h-full lg:w-1/3 lg:box-border lg:border-8 lg:border-theme1-white border-8 border-theme1-white group'>
                ...
                <div className=' lg:hidden absolute bottom-6 right-2 text-2xl hover:underline hover:decoration-theme1-orange hover:cursor-pointer z-20 group-hover:text-theme1-white group-hover:underline group-hover:decoration-theme1-orange'><a href='https://musicappak.netlify.app/'>Unspotify <br/> Music Player</a></div>
                ...
                <img src={unspotify} className=' lg:object-cover lg:h-full lg:w-full lg:object-top'/>
              </div>
            ...
            <div className='hidden lg:block lg:relative lg:row-start-3 lg:m-3 lg:text-right lg:z-10'>
              <div className=' lg:text-5xl lg:hover:underline lg:hover:decoration-theme1-orange lg:hover:cursor-pointer lg:z-20'><a href='https://musicappak.netlify.app/'>Unspotify <br/> Music Player</a></div>
            ...
            <div className=' hidden lg:block lg:relative lg:row-start-3 lg:m-3 lg:text-right lg:z-10'>
              <div className=' lg:text-5xl lg:hover:underline lg:hover:decoration-theme1-orange lg:hover:cursor-pointer lg:z-20'><a href='https://router-projectak.netlify.app/'>API Integration<br/> Project </a></div>
