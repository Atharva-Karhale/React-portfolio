    ...
    return(
        <nav className='w-full h-full '>
            <div className={`flex relative size-full ${isHovered ? 'bg-theme1-gray ' : ''}`} onMouseEnter={handleMouseEnter}
                ...
                {isHovered && <img src='./Assets/1x/Pattern.png' className='absolute inset-0 h-full w-full object-cover opacity-10'/>}
                <img src='/Assets/1x/Logo.png' className=' mx-auto h-12 py-1.5' alt='Atharva_Karhale-Wordmark'/>
