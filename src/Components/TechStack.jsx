...
export default function TechStack({ heading }) {
    ...
    return(
        ...
        onMouseLeave={handleMouseLeave}>
            ...
            {isHovered && <img src='./src/Assets/1x/tailwind-logo-b&w.png' className=' size-8 col-span-1 mx-auto animate-spin mix-blend-differe'/>}

            <div className='col-span-1'>{heading}</div>

            {isHovered && <img src='src/Assets/1x/react_icon.webp' className=' size-8  col-span-1 mx-auto animate-spin mix-blend-screen'/>}
        </div>
    );
}